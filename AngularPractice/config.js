...
window.config = {
  ...
  map: {
      ...
      'rxjs': 'npm:rxjs@6.4.0',
      'devextreme-aspnet-data-nojquery': 'npm:devextreme-aspnet-data-nojquery@2.8.4/index.js',
      ...
      'devextreme/bundles/dx.all': 'npm:devextreme@21.1.5/bundles/dx.all.js',
      'jszip': 'npm:jszip@3.7.0/dist/jszip.min.js',
      'devextreme-quill': 'npm:devextreme-quill@1.3.1/dist/dx-quill.min.js',
      'devexpress-diagram': 'npm:devexpress-diagram@2.1.25',
      'devexpress-gantt': 'npm:devexpress-gantt@3.0.4',
      'devextreme-angular': 'npm:devextreme-angular@21.1.5',
